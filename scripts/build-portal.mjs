...
<html lang="es-EC" data-theme="light"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex"><meta name="theme-color" content="${SITE_CONFIG.themeColors.primary}"><title>Página no encontrada | SIPA UTMACH</title>
...
<style>:root{color-scheme:light;font-family:system-ui,-apple-system,"Segoe UI",sans-serif;background:#F3FAF5;color:#142018}html[data-theme=dark]{color-scheme:dark;background:#09110C;color:#F3F8F4}*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:24px;background:linear-gradient(145deg,rgba(21,129,68,.12),transparent 55%)}main{width:min(680px,100%);padding:clamp(28px,7vw,64px);border:1px solid rgba(21,129,68,.24);border-radius:20px;background:color-mix(in srgb,Canvas 94%,#DCEFE2 6%);box-shadow:0 24px 70px rgba(7,23,13,.12)}.mark{display:inline-grid;place-items:center;width:64px;height:64px;border-radius:18px;background:#116A38;color:#fff;font-weight:800;letter-spacing:.06em}p{line-height:1.7}h1{font-size:clamp(2rem,7vw,4rem);line-height:1.05;margin:.8em 0 .3em}a{display:inline-flex;min-height:44px;align-items:center;margin-top:14px;padding:10px 18px;border-radius:10px;background:#116A38;color:#fff;font-weight:700;text-decoration:none}a:focus-visible{outline:3px solid #158144;outline-offset:4px}.domain{font-size:.78rem;letter-spacing:.12em;font-weight:800;color:#116A38}html[data-theme=dark] body{background:linear-gradient(145deg,rgba(78,173,116,.12),transparent 55%)}html[data-theme=dark] main{border-color:rgba(131,196,154,.32);background:color-mix(in srgb,Canvas 94%,#17271B 6%);box-shadow:0 24px 70px rgba(0,0,0,.32)}html[data-theme=dark] .mark,html[data-theme=dark] a{background:#4EAD74;color:#07170D}html[data-theme=dark] a:focus-visible{outline-color:#83C49A}html[data-theme=dark] .domain{color:#83C49A}</style></head>
