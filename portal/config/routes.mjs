...
const routeDefinitions = [
  ...
  page({
    ...
    description: 'Equipo docente, ayudantías, comunicación y desarrollo digital del semillero SIPA UTMACH.',
    navLabel: 'Equipo',
    navOrder: 60,
    sections: [
      { id: 'docentes', label: 'Docentes y dirección académica' },
      { id: 'ayudantias', label: 'Ayudantías académicas y de campo' },
      { id: 'comunicacion-digital', label: 'Comunicación y desarrollo digital' },
      { id: 'otros', label: 'Otros integrantes' },
    ],
